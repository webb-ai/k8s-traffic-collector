...
require (
	...
	github.com/kubeshark/worker/extensions/redis v0.0.0
...
replace github.com/kubeshark/worker/extensions/http v0.0.0 => ./extensions/http

replace github.com/kubeshark/worker/extensions/kafka v0.0.0 => ./extensions/kafka

replace github.com/kubeshark/worker/extensions/redis v0.0.0 => ./extensions/redis
